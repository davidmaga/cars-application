...
import com.dmc.cars.domain.Region;
import com.dmc.cars.repository.RegionRepository;
...
class RegionResourceIT {
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return region;
    }
    ...
    void putNewRegion() throws Exception {
        ...
        updatedRegion.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
