...
class DealerResourceIT {
    ...
    void createDealer() throws Exception {
        ...
        assertThat(testDealer.getPhotoPath()).isEqualTo(DEFAULT_PHOTO_PATH);
    ...
    void putNewDealer() throws Exception {
        ...
        updatedDealer.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH).address(UPDATED_ADDRESS);
        ...
        assertThat(testDealer.getPhotoPath()).isEqualTo(UPDATED_PHOTO_PATH);
    ...
    void partialUpdateDealerWithPatch() throws Exception {
        ...
        partialUpdatedDealer.description(UPDATED_DESCRIPTION).address(UPDATED_ADDRESS);
    ...
    void fullUpdateDealerWithPatch() throws Exception {
        ...
        partialUpdatedDealer.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH).address(UPDATED_ADDRESS);
