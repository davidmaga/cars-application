...
class BrandResourceIT {
    ...
    public static Brand createEntity(EntityManager em) {
        Brand brand = new Brand().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).photoPath(DEFAULT_PHOTO_PATH);
        return brand;
    }
    ...
    public static Brand createUpdatedEntity(EntityManager em) {
        Brand brand = new Brand().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH);
        return brand;
    }
    ...
    void createBrand() throws Exception {
        ...
        assertThat(testBrand.getPhotoPath()).isEqualTo(DEFAULT_PHOTO_PATH);
    }
    ...
    void putNewBrand() throws Exception {
        ...
        updatedBrand.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH);
        ...
        assertThat(testBrand.getPhotoPath()).isEqualTo(UPDATED_PHOTO_PATH);
    }
    ...
    void partialUpdateBrandWithPatch() throws Exception {
        ...
        partialUpdatedBrand.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateBrandWithPatch() throws Exception {
        ...
        partialUpdatedBrand.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH);
