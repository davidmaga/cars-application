...
class ModelResourceIT {
    ...
    public static Model createEntity(EntityManager em) {
        Model model = new Model().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        return model;
    }
    ...
    public static Model createUpdatedEntity(EntityManager em) {
        Model model = new Model().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        return model;
    }
    ...
    void putNewModel() throws Exception {
        ...
        updatedModel.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateModelWithPatch() throws Exception {
        ...
        partialUpdatedModel.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
