...
import com.dmc.cars.domain.Category;
import com.dmc.cars.repository.CategoryRepository;
...
class CategoryResourceIT {
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).photoPath(DEFAULT_PHOTO_PATH);
        return category;
    }
    ...
    public static Category createUpdatedEntity(EntityManager em) {
        Category category = new Category().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH);
        return category;
    }
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getPhotoPath()).isEqualTo(DEFAULT_PHOTO_PATH);
    }
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH);
        ...
        assertThat(testCategory.getPhotoPath()).isEqualTo(UPDATED_PHOTO_PATH);
    }
    ...
    void fullUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photoPath(UPDATED_PHOTO_PATH);
